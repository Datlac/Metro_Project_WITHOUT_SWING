...
public class DataLoader {
    ...
    // Hãy thử đổi lại đường dẫn ở đây nếu cần
    ...
    public static List<Customer> loadCustomersFromFile() {
        ...
        if (!file.exists()) {
            ...
            System.err.println("Gợi ý: Hãy kiểm tra xem file 'customers.txt' có nằm đúng đường dẫn trên không.");
            return customerList; // Trả về list rỗng để không crash chương trình
        }
        // -------------------------------
